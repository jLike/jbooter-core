...
const _ = require('lodash'),
  ...
  FieldTypes = require('../core/jbooter/field_types'),
  RelationshipTypes = require('../core/jbooter/relationship_types').RELATIONSHIP_TYPES,
  DatabaseTypes = require('../core/jbooter/database_types'),
  ...
  UnaryOptions = require('../core/jbooter/unary_options').UNARY_OPTIONS,
  BinaryOptions = require('../core/jbooter/binary_options').BINARY_OPTIONS,
...
function initializeEntities() {
  for (let i = 0, entityNames = Object.keys(jdlObject.entities); i < entityNames.length; i++) {
     ...
     * created JBooter User entity and none of its fields and ownerside
    ...
    if (entityName.toLowerCase() === USER.toLowerCase()) {
      console.warn("Warning:  An Entity name 'User' was used: 'User' is an" +
        ' entity created by default by JBooter. All relationships toward' +
