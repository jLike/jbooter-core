...
const _ = require('lodash'),
  ...
  UnaryOptions = require('../core/jbooter/unary_options'),
  BinaryOptions = require('../core/jbooter/binary_options'),
  ...
  isReservedClassName = require('../core/jbooter/reserved_keywords').isReservedClassName,
  isReservedFieldName = require('../core/jbooter/reserved_keywords').isReservedFieldName,
