...
const expect = require('chai').expect,
  ...
  UnaryOptions = require('../../../lib/core/jbooter/unary_options').UNARY_OPTIONS,
  BinaryOptions = require('../../../lib/core/jbooter/binary_options').BINARY_OPTIONS,
  BinaryOptionValues = require('../../../lib/core/jbooter/binary_options').BINARY_OPTION_VALUES;

describe('::parse', () => {
  const entities = {
    Employee: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Employee.json'),
    Country: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Country.json'),
    Department: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Department.json'),
    JobHistory: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/JobHistory.json'),
    Location: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Location.json'),
    Region: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Region.json'),
    Job: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Job.json'),
    Task: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Task.json')
  };
  ...
  describe('when parsing app config file to JDL', () => {
    const yoRcJson = Reader.readEntityJSON('./test/test_files/jbooter_app/.yo-rc.json');
    const content = Parser.parseServerOptions(yoRcJson['generator-jbooter']);
  ...
  describe('when parsing entities with relationships to User', () => {
    describe('when skipUserManagement flag is not set', () => {
      describe('when there is no User.json entity', () => {
        ...
        const content = Parser.parseEntities(entities);
        it('parses relationships to the JBooter managed User entity', () => {
        ...
        it('throws an error ', () => {
          try {
            Parser.parseEntities({
              Country: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Country.json'),
              User: Reader.readEntityJSON('./test/test_files/jbooter_app/.jbooter/Region.json')
            });
            fail();
          } catch (error) {
    ...
    describe('when skipUserManagement flag is set', () => {
      ...
      const yoRcJson = Reader.readEntityJSON('./test/test_files/jbooter_app/.yo-rc.json');
      yoRcJson['generator-jbooter'].skipUserManagement = true;
      const content = Parser.parseServerOptions(yoRcJson['generator-jbooter']);
