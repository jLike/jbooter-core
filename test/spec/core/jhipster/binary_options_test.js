...
const expect = require('chai').expect,
  BINARY_OPTIONS = require('../../../../lib/core/jbooter/binary_options').BINARY_OPTIONS,
  BINARY_OPTION_VALUE = require('../../../../lib/core/jbooter/binary_options').BINARY_OPTION_VALUES,
  exists = require('../../../../lib/core/jbooter/binary_options').exists;
